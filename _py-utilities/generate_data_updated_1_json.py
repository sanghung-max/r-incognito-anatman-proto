...
# Recognized H2 section header mappings
VALID_SECTION_KEYS = {
    "vista": "觀景 vista",
    "觀景": "觀景 vista",
    "觀景 / vista": "觀景 vista",
...
def clean_path(path_str):
    """Normalize web relative paths by using forward slashes and stripping leading slashes."""
    if not path_str:
        return ""
...
def alphanumeric_sort_key(node_id):
    """
    Custom sort key to ensure 1..9 come first numerically, 
    followed by uppercase/lowercase letters A, B, C... M.
    """
...
def parse_md_file(file_path):
    ...
    # =========================================================================
    # 1. Parse Body Sections & Optimize Space
    # =========================================================================
    sections = {}
    curr_sec = None
